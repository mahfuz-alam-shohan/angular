...
@Component({
  selector: 'debate-competition',
  templateUrl: './debate-competition.component.html',
  styleUrls: ['./debate-competition.component.scss']
})
export class DebateCompetitionComponent implements OnInit
{
