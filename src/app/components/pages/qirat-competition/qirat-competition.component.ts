...
@Component({
  selector: 'qirat-competition',
  templateUrl: './qirat-competition.component.html',
  styleUrls: ['./qirat-competition.component.scss']
})
export class QiratCompetitionComponent implements OnInit
{
