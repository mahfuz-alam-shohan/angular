...
@Component({
  selector: 'quiz-competition',
  templateUrl: './quiz-competition.component.html',
  styleUrls: ['./quiz-competition.component.scss']
})
export class QuizCompetitionComponent implements OnInit
{
