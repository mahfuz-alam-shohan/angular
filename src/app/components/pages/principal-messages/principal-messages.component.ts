...
@Component({
  selector: 'app-principal-messages',
  templateUrl: './principal-messages.component.html',
  styleUrls: ['./principal-messages.component.scss']
})
export class PrincipalMessagesComponent  {
