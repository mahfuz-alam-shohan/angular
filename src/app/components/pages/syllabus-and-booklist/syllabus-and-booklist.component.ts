...
@Component({
  selector: 'syllabus-and-booklist',
  templateUrl: './syllabus-and-booklist.component.html',
  styleUrls: ['./syllabus-and-booklist.component.scss']
})
export class SyllabusAndBooklistComponent implements OnInit
{
